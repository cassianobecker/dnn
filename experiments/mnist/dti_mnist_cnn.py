...
from nn.DtiConv3d import DtiConv3d
...
class Net(nn.Module):
    ...
    def __init__(self, lift_dim=6):
        ...
        self.conv1 = DtiConv3d(c_out1, kernel_dims, skip)
        self.conv2 = nn.Conv3d(c_out1, c_out2, kernel_dims, skip)
